...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send('service_tlnwbly','template_mhql8s3',
      {
        from_name: form.name,
        to_name: 'Nixon Raja K',
        from_email: form.email,
        to_email: 'nixonraja74@gmail.com',
  ...
  return (
    <div className="xl: mt-12 xl:flex-row flex-col-reverse flex gap-10 overflow-hidden">
      ...
      >
        ...
        <form ref={fromRef} onSubmit={handleSubmit} className="mt-2 flex flex-col gap-8">
          <label className="flex flex-col"><span className="tewxt-white font-medium mb-4">Your Name</span>
          ...
          <label className="flex flex-col"><span className="tewxt-white font-medium mb-4">Your Email</span>
          ...
          <label className="flex flex-col"><span className="tewxt-white font-medium mb-4">Your Message</span>
